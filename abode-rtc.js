/* mca-rtc.js — Cascade & Pine Realty (AEHub) NATIVE video conferencing (own WebRTC, no third party)
   ------------------------------------------------------------------------
...
(function () {
  ...
  var API = (window.ABODE_API||'https://ae-connect-api.vercel.app')+'/api/connect';
  ...
  window.AbodeMeet = ESPOAPI; window.MCAMeet = ESPOAPI; window.ESPOMeet = ESPOAPI; window.LCPMeet = ESPOAPI;
})();
