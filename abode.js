...
(function (global) {
  ...
  var TIERS = {
    lite: { key:"lite", name:"Core", rank:1, mo:450, build:0,
    ...
    standard: { key:"standard", name:"Elite", rank:2, mo:950, build:0,
    ...
    grandsuite: { key:"grandsuite", name:"Mothership", rank:3, mo:2400, build:0,
